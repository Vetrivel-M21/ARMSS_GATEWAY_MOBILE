package com.armss.armss_gateway_mobile
...
class MainActivity : FlutterActivity() {
    private val CHANNEL = "com.armss.armss_gateway_mobile/app_installer"
            ...
            when (call.method) {
                ...
                "installApk" -> {
                    ...
                    try {
                        ...
                        result.error("INSTALL_FAILED", e.localizedMessage, e.toString())
                    }
                }
